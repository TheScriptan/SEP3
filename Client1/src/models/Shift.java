...
public class Shift {
	...
	public Shift(long shiftId, long companyId, Date shiftDate, int shiftTime, String shiftRequirements, boolean released) {
		this.shiftId = shiftId;
		this.companyId = companyId;
		this.shiftDate = shiftDate;
		this.shiftTime = shiftTime;
	...
	public String toString() {
		return "Shift [shiftId=" + shiftId + ", companyId=" + companyId + ", shiftDate=" + shiftDate + ", shiftTime="
				+ shiftTime + ", shiftRequirements=" + shiftRequirements + ", released="+ released+"]";
	}
}
